...
class ReadmeTests(unittest.TestCase):
    def test_readme_shows_demo_and_output_preview(self):
        ...
        self.assertIn("agent-workbench demo --adapter claude --adapter codex --adapter cursor --check", readme)
        ...
        self.assertIn("--adapter claude --adapter codex --adapter cursor", readme)
        ...
        self.assertIn("docs/release-v0.7.0.md", readme)
