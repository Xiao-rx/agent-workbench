...
class ReadmeTests(unittest.TestCase):
    def test_readme_shows_demo_and_output_preview(self):
        ...
        self.assertIn("agent-workbench demo --adapter all --check --format json", readme)
        self.assertIn("agent-workbench init . --output .agent-workbench --adapter all --check --format json", readme)
