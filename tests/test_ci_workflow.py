...
class CiWorkflowTests(unittest.TestCase):
    def test_ci_validates_strict_demo_proof(self):
        ...
        self.assertIn("grep -q \"<repo>\" /tmp/agent-workbench-demo-report/demo-report.md", workflow)
        self.assertIn("grep -q \"<workbench>\" /tmp/agent-workbench-demo-report/demo-report.md", workflow)
        self.assertIn("grep -q \"<demo-workspace>\" /tmp/agent-workbench-demo-report/demo-report.md", workflow)
        self.assertIn("grep -q \"<report>\" /tmp/agent-workbench-demo-report/demo-report.md", workflow)
        self.assertIn("! grep -q \"/tmp/agent-workbench-demo-report\" /tmp/agent-workbench-demo-report/demo-report.md", workflow)
