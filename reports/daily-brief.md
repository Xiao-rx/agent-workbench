...
Generated: 2026\-07\-27T01:08:42Z
...
- [affaan\-m/ECC](https://github.com/affaan-m/ECC) - 233676 stars - The agent harness performance optimization system\. Skills, instincts, memory, security, and research\-first development for Claude Code, Codex, Opencode, Cursor and beyond\.
- [multica\-ai/andrej\-karpathy\-skills](https://github.com/multica-ai/andrej-karpathy-skills) - 196561 stars - A single CLAUDE\.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls\.
- [ultraworkers/claw\-code](https://github.com/ultraworkers/claw-code) - 194927 stars - An agent\-managed museum exhibit, built in Rust with Gajae\-Code / LazyCodex — developed and maintained with no human intervention\.
- [mattpocock/skills](https://github.com/mattpocock/skills) - 189613 stars - Skills for Real Engineers\. Straight from my \.agents directory\.
- [garrytan/gstack](https://github.com/garrytan/gstack) - 124575 stars - Use Garry Tan's exact Claude Code setup: 23 opinionated tools that serve as CEO, Designer, Eng Manager, Release Manager, Doc Engineer, and QA
- [VoltAgent/awesome\-design\-md](https://github.com/VoltAgent/awesome-design-md) - 104700 stars - A collection of DESIGN\.md files analysis by popular brand design systems\. Drop one into your project and let coding agents generate a matching UI\.
- [Graphify\-Labs/graphify](https://github.com/Graphify-Labs/graphify) - 96464 stars - Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowledge graph\. A /graphify skill for Claude Code, Cursor, Codex, and Gemini CLI: local deterministic AST parsing, every edge explained, no vector store\.
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) - 93214 stars - 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman
- [karpathy/autoresearch](https://github.com/karpathy/autoresearch) - 92100 stars - AI agents running research on single\-GPU nanochat training automatically
- [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) - 89835 stars - Makes your AI agent think like the laziest senior dev in the room\. The best code is the code you never wrote\.
...
- affaan\-m/ECC
  ...
  - Evidence: 233676 stars; 35617 forks corroborate reuse; MIT license; recent push activity
...
- multica\-ai/andrej\-karpathy\-skills
  ...
  - Evidence: 196561 stars; 20234 forks corroborate reuse; unclear license
...
- Forks: 0
- Open issues: 0
- Sampled at: 2026\-07\-27T01:08:42Z
