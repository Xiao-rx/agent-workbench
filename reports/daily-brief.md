...
Generated: 2026\-08\-17T23:47:26Z
...
- [affaan\-m/ECC](https://github.com/affaan-m/ECC) - 240697 stars - The agent harness performance optimization system\. Skills, instincts, memory, security, and research\-first development for Claude Code, Codex, Opencode, Cursor and beyond\.
- [mattpocock/skills](https://github.com/mattpocock/skills) - 220307 stars - Skills for Real Engineers\. Straight from my \.agents directory\.
- [multica\-ai/andrej\-karpathy\-skills](https://github.com/multica-ai/andrej-karpathy-skills) - 203380 stars - A single CLAUDE\.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls\.
- [ultraworkers/claw\-code](https://github.com/ultraworkers/claw-code) - 195066 stars - An agent\-managed museum exhibit, built in Rust with Gajae\-Code / LazyCodex — developed and maintained with no human intervention\.
- [deepseek\-ai/deepseek\-harness](https://github.com/deepseek-ai/deepseek-harness) - 149749 stars - DeepSeek Harness: Everything is a Plugin\.
- [garrytan/gstack](https://github.com/garrytan/gstack) - 128413 stars - Use Garry Tan's exact Claude Code setup: 23 opinionated tools that serve as CEO, Designer, Eng Manager, Release Manager, Doc Engineer, and QA
- [VoltAgent/awesome\-design\-md](https://github.com/VoltAgent/awesome-design-md) - 108939 stars - A collection of DESIGN\.md files analysis by popular brand design systems\. Drop one into your project and let coding agents generate a matching UI\.
- [Graphify\-Labs/graphify](https://github.com/Graphify-Labs/graphify) - 107501 stars - Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowledge graph\. A /graphify skill for Claude Code, Cursor, Codex, and Gemini CLI: local deterministic AST parsing, every edge explained, no vector store\.
- [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) - 104730 stars - Makes your AI agent think like the laziest senior dev in the room\. The best code is the code you never wrote\.
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) - 98743 stars - 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman
...
- affaan\-m/ECC
  ...
  - Evidence: 240697 stars; 36508 forks corroborate reuse; MIT license; recent push activity
...
- mattpocock/skills
  ...
  - Evidence: 220307 stars; 18988 forks corroborate reuse; MIT license; recent push activity
  - Emulate: Use a concrete one\-sentence value proposition\.; Keep license and reuse rights explicit\.; Show active maintenance through recent commits\.
  - Avoid: Avoid copying surface topics without reproducing the proof path\.
- multica\-ai/andrej\-karpathy\-skills
  - Trust: medium (70/100)
  - Why popular: multica\-ai/andrej\-karpathy\-skills is likely gaining attention because it combines AI/agent positioning\.
  - Evidence: 203380 stars; 20864 forks corroborate reuse; unclear license
...
- ultraworkers/claw\-code
  ...
  - Evidence: 195066 stars; 109077 forks corroborate reuse; MIT license; recent push activity
  - Emulate: Use a concrete one\-sentence value proposition\.; Keep license and reuse rights explicit\.; Show active maintenance through recent commits\.
  - Avoid: Avoid copying surface topics without reproducing the proof path\.
- deepseek\-ai/deepseek\-harness
  - Trust: high (100/100)
  ...
  - Evidence: 149749 stars; 15349 forks corroborate reuse; MIT license; 0 open issues; recent push activity
  - Emulate: Use a concrete one\-sentence value proposition\.; Keep license and reuse rights explicit\.; Show active maintenance through recent commits\.
  - Avoid: Avoid copying surface topics without reproducing the proof path\.
...
- Forks: 0
- Open issues: 0
- Sampled at: 2026\-08\-17T23:47:26Z
