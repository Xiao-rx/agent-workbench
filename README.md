...
$env:PYTHONPATH='src'
uv run --python 3.12 python -m agent_workbench demo --adapter claude --adapter codex --adapter cursor --check
```
...
```powershell
uv run --python 3.12 python -m agent_workbench init . --output .agent-workbench --adapter claude --adapter codex --adapter cursor
```
...
```text
agent-workbench demo [--output PATH] [--adapter claude] [--adapter codex] [--adapter cursor] [--check]
...
agent-workbench init [ROOT] --output .agent-workbench --project-name NAME [--adapter claude] [--adapter codex] [--adapter cursor] [--check]
...
python -m agent_workbench init [ROOT] --output .agent-workbench --project-name NAME [--adapter claude] [--adapter codex] [--adapter cursor] [--check]
python -m agent_workbench demo [--output PATH] [--adapter claude] [--adapter codex] [--adapter cursor] [--check]
```

## Release

- Current release notes: [`docs/release-v0.7.0.md`](docs/release-v0.7.0.md)
